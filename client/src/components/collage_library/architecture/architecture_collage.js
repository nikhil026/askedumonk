...
class Architecture_Collage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activePage: 1
          ...
          <div className="container1">
            <div className="row">
              ...
              <div className="col-md-7 col-xs-10 clgprofiledes">
                <h3>Top Architecture Collage</h3>
                ...
                <div className="coursedessside detail-content-wrapper">
                  <div id="section-0" className="detail-content">
                    <h2 className="heading-new">
                      <span>Ranking Architecture collage</span>
                    </h2>
...
For India Rankings – 2017, the main ranking parameters remain the same. However, there are a few significant changes in a few sub-parameters. Also, this year every large institution will be given a common overall rank as well as a discipline specific rank as applicable. Details are in the Ranking Document available at 
                  ...
                  <div id="section-1" className="detail-content clearfix">
                    <h2 className="heading-new">
                      <span>Ranking Wise Architecture Collage</span>
                    </h2>
                   
                    {this.state.activePage === 1? 
                    <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/spa_detail">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/iit_kharagpur_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/iit_roorkee_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/sjjca_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/nit_trichy_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/juk_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/bit_mesra_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/ceptu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/cca_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/ssaa_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 2? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/jmi_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/nit_calicut_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/rcam_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/mum_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/rvce_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/auc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/manit_bhopal_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/mnit_jaipur_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/vnit_nagpur_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/vka_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 3? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/niu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/nmims_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/uvce_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/nimsu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/rit_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/su_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/lpu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/abit_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/dypca_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/mriirs_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 4? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/nit_hamirpur_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/gsa_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/nitp_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/kits_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/coet_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/bjgi_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/nit_raipur_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/aug_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/arcist_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/juj_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 5? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/cuc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/srmec_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/sist_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/luf_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/auce_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/rsdca_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/bssa_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/bddca_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/nua_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_architecture/bldea_detail">
                        <p className="brnchname">
...
export default Architecture_Collage;
