...
class Commerce_Collage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activePage: 1
                ...
                <div className="coursedessside detail-content-wrapper">
                  <div id="section-0" className="detail-content">
                    <h2 className="heading-new">
                      <span>Ranking Commerce collage</span>
                    </h2>
...
For India Rankings – 2017, the main ranking parameters remain the same. However, there are a few significant changes in a few sub-parameters. Also, this year every large institution will be given a common overall rank as well as a discipline specific rank as applicable. Details are in the Ranking Document available at 
                  ...
                  <div id="section-1" className="detail-content clearfix">
                    <h2 className="heading-new">
                      <span>Ranking Wise Commerce Collage</span>
                    </h2>
                   
                    {this.state.activePage === 1? 
                    <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/srcc_detail">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/lsrc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/sgt_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/iit_kharagpur_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/hindu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/apeejay_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/hanraj_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/icw_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/dcac_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 2? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/kiit_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/jmc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/sbsc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/sggs_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/ramjas_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/krc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/ggsiu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/jmiu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/jgu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/du_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 3? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/mdu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/niu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/amity_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/su_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/mriir_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/ccs_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/ansal_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/iitm_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 4? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/iitmgn_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/fimt_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/scmt_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/ignou_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/rcit_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/agbs_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/sum_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/kmu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/pcet_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/mim_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 5? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/imegc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/apgc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/sru_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/svsu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/amv_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/kiheat_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/hlm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_collage_commerce/ncu_detail">
                        <p className="brnchname">
...
export default Commerce_Collage;
