...
class MediaMass extends Component {
  render() {
    return (
          ...
          <div className="container1">
            <div className="row">
              <div className="col-md-2 col-xs-2">
                <img
                  src={require("../.././images/media--mass-communication.media-and-mass-communication.jpg")}
                  alt=""
                />
              </div>
              <div className="col-md-7 col-xs-10 clgprofiledes">
                <h3>Media &amp; Mass Communication</h3>
                ...
                <div className="coursedessside detail-content-wrapper">
                  <div id="section-0" className="detail-content">
                    <h2 class="heading-new">
                      <span>About Media &amp; Mass Communication</span>
                    </h2>
