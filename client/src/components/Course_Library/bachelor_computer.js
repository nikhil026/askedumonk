...
class BOComputer extends Component {
  render() {
    return (
                  ...
                  <div className="coursecontdes">
                    <p>
                      <span style={{ "font-size": "14px" }}>
                        ...
                        is a course in <strong>PC applications.</strong> With
                        its fast development in India, the request of skilled
                        computer worker is expanding step by step. This
                        expanding development of the IT industry has made plenty
                        of chances for the <strong>PC graduates.</strong>
                      </span>
                    </p>
                    <p>
                      <span style={{ "font-size": "14px" }}>
                        The length of the course is
                        <strong>&nbsp;3 years&nbsp;</strong>and separated into{" "}
                        <strong>6 semesters.</strong> It involves the subjects
                        like a database, organizing, information structure,
                        center programmings like{" "}
                        <strong>'C' and 'java'.</strong> This course gives a
                        considerable measure of chances to the candidates who
                        are occupied with computer field and needs to work in
                        the IT division as{" "}
                        <strong>developer or programming engineer.</strong>
                      </span>
                    </p>
                    <p>
                      <span style={{ "font-size": "14px" }}>
