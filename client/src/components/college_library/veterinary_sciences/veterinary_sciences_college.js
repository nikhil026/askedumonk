...
class Veterinary_Sciences_college extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activePage: 1
          ...
          <div className="container1">
            <div className="row">
              ...
              <div className="col-md-7 col-xs-10 clgprofiledes">
                <h3>Top Veterinary Science college</h3>
                ...
                <div className="coursedessside detail-content-wrapper">
                  <div id="section-0" className="detail-content">
                    <h2 className="heading-new">
                      <span>Ranking Veterinary college</span>
                    </h2>
...
For India Rankings – 2017, the main ranking parameters remain the same. However, there are a few significant changes in a few sub-parameters. Also, this year every large institution will be given a common overall rank as well as a discipline specific rank as applicable. Details are in the Ranking Document available at 
                  ...
                  <div id="section-1" className="detail-content clearfix">
                    <h2 className="heading-new">
                      <span>Ranking Wise Veterinary college</span>
                    </h2>
                   
                    {this.state.activePage === 1? 
                    <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/ivri_detail">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/ndri_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/gbpuat_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/vcri_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/cvas_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/bau_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/pajuvas_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/bhu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/ouc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/amu_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 2? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/buj_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/jau_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/ouat_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/suj_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/eiilm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/rajuvas_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/nrcm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/svbpuat_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/wbuafs_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/kvasu_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 3? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/aau_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/skuast_detail">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/cskhpkv_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/tanuvas_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/csauat_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/upcv_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/sdau_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/kvafsu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/svvu_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 4? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/mafsu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/bvc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/cau_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/nduat_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/nrcc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/naun_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/ragacovas_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/gadvasu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/cgkv_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/nou_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/nvc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/acvm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/bvcp_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/cap_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/can_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/cobs_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/covas_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_veterinary_scienve/cvsg_detail">
                        <p className="brnchname">
...
export default Veterinary_Sciences_college;
