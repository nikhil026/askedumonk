...
class Hotel_Management_college extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activePage: 1
          ...
          <div className="container1">
            <div className="row">
              ...
              <div className="col-md-7 col-xs-10 clgprofiledes">
                <h3>Top Hotel Management college</h3>
...
For India Rankings – 2017, the main ranking parameters remain the same. However, there are a few significant changes in a few sub-parameters. Also, this year every large institution will be given a common overall rank as well as a discipline specific rank as applicable. Details are in the Ranking Document available at 
                  ...
                  <div id="section-1" className="detail-content clearfix">
                    <h2 className="heading-new">
                      <span>Ranking Wise Managment college</span>
                    </h2>
                   
                    {this.state.activePage === 1? 
                    <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_detail">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihmcn_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/puv_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_bangalore_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ish_gurgaon_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_kolkata_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/iihm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_chennai_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_chandigarh_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihmct_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 2? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ocld_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/aihmct_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_gandhinagar_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_hyderabad_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ichm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_ngoa_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_jodpur_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_panipat_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/aihm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/aih_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 3? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihmc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/siop_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_guwahati_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_lucknow_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/csh_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ushmct_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/sschm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/cihm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/dbihmct_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 4? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/gnihm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/vuc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/mcc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_kurukshetra_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/kchm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_bhubaneswar_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/cchmct_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_degradun_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/oshml_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_gwalior_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 5? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/cihmct_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/pihmct_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_gurdaspur_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_meerut_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/sihm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_bathinda_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_faridabad_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/nithm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/dihm_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_hotel_management/ihm_gangtok_detail">
                        <p className="brnchname">
...
export default Hotel_Management_college;
