...
class Medical_college extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activePage: 1
                ...
                <div className="coursedessside detail-content-wrapper">
                  <div id="section-0" className="detail-content">
                    <h2 className="heading-new">
                      <span>Ranking Medical college</span>
                    </h2>
...
For India Rankings – 2017, the main ranking parameters remain the same. However, there are a few significant changes in a few sub-parameters. Also, this year every large institution will be given a common overall rank as well as a discipline specific rank as applicable. Details are in the Ranking Document available at 
                  ...
                  <div id="section-1" className="detail-content clearfix">
                    <h2 className="heading-new">
                      <span>Ranking Wise Medical college</span>
                    </h2>
                   
                    {this.state.activePage === 1? 
                    <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/aiims_detail">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/pgimer_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/cmc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/sgpims_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/avv_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/bhu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/kmc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/jipgmer_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/ilbs_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/kgmu_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 2? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/sriher_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/sjmc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/amu_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/mamc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/jh_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/kamc_detail">
                        <p className="brnchname">
                          <i className="fa fa-database" />Kasturba Medical College
                        </p>
                        <p>
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/jssmc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/vmmcsh_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/ddypv_detail">
                        <p className="brnchname">
                    ...
                    {this.state.activePage === 3? 
                      <div className="col-md-4 mrgn-branches"> 
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/soa_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/srmist_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/ucms_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/dmc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/simts_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/anau_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/msrmc_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/rims_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/svims_detail">
                        <p className="brnchname">
                    ...
                    <div className="col-md-4 mrgn-branches">
                      <Link to="/list_college_medical/kiit_detail">
                        <p className="brnchname">
...
export default Medical_college;
