...
class Coverflows extends Component {
    ...
    enableHeading={false}
  >
    <div id="collagesearch"><div id="horizontal1">college <br /> search </div><div id="searcher">Find The Best College <br /> <Link id="boder" to="/collage_search" >search</Link> </div></div>
