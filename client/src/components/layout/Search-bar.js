              ...
              <div class="form affix">
                <div className="row">
                  <div className="col-lg-4">
                    ...
                    <p>I need help in choosing</p>
                    <input type="radio" /> Career
                    <input type="radio" name="gender" /> Study Stream
                    <input type="radio" name="gender" /> College
                    <br />
                    <Link
                      to="/"
                      className="purchsetestbtnfrree4"
                      style={{
                        "margin-top": "35px",
                        "margin-left": "70px",
                        padding: "10px",
          ...
          <section className=" assessment-ex-area">
            <div className="container">
              <div className="row">
                ...
                <div className=" testexplainboxh col-md-6 info">
                  <h3>
                    Attend <span style={{ color: "red" }}>Live Webinars</span>To
                    Ask & Discuss Career Queries With Edumonk
                  </h3>
                  <p>
                    <span style={{ "font-size": "16px" }}>
