...
class TopCourse extends Component {
  render() {
    return (
      <section className="pt-20 pb-60 " id="admissionassist">
        <div className="container1">
          <div className="row">
            <div className="heading_s1 text-center">
              <h2>
                Top <span className="specialatt">Courses</span>
              </h2>
            </div>
          </div>
          <div className="row">
            <div className="col-md-12 cafrightside">
              <div className="tagcourseexam">
                ...
                >
                  <span> Bachelor of Hotel Management </span>
                </Link>
                ...
                >
                  <span> Logistics and Supply Chain Management </span>
                </Link>
                ...
                >
                  <span> Fashion Design Courses </span>
                </Link>
                ...
                >
                  <span> Bachelor of Ayurveda, Medicine and Surgery </span>
                </Link>
                ...
                >
                  <span> Master of Dental Surgery </span>
                </Link>
                ...
                >
                  <span> Masters of Physiotherapy </span>
                </Link>
                ...
                >
                  <span> MBA in Human Resource Management </span>
                </Link>
                ...
                >
                  <span> Masters in Aeronautical Engineering </span>
                </Link>
                ...
                >
                  <span> Electronics &amp; Tele-communication </span>
                </Link>
                ...
                >
                  <span> Bachelor of Business Management </span>
                </Link>
                ...
                >
                  <span> Metallurgical Engineering </span>
                </Link>
              ...
              <Link rel="" className="cafbutton" to="course-options.php">
                View All Courses
              </Link>
            </div>
          </div>
