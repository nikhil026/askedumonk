...
class AskEdumonk extends Component {
  render() {
    return (
            ...
            <div className="eight wide column">
              ...
              <div className="segment ask_segment">
                <div className="ui two item top attached menu">
                  <Link
                    to="/ask_edumonk"
                    className="item discuss_item ff1 active"
                ...
                <div
                  className="ui transition fade in tab ask_tab ask_community active"
                  data-tab="ask_community"
                >
                  <div className="ui bottom attached segment">
                    <div className="ui form">
                      ...
                      <div className="ui bottom attached labeled fluid input field tag_field">
                        ...
                        <div className="ui selection multiple search dropdown company_select ff1 active visible">
                      ...
                      <div className="ui at_footer">
                        <div
                          className="ui selection upward dropdown topic_select ff1 active visible"
                          tabindex="0"
                        >
                          <input
                            className="ff1"
                ...
                <div
                  className="ui transition fade in tab ask_tab create_poll"
                  data-tab="create_poll"
                >
                  <div className="ui bottom attached segment">
                    <div className="ui form">
